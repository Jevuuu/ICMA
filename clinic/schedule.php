            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  schedule where clinic_id=$userid;");
                ...
                $sqlmain= "select schedule.sched_id,schedule.sched_name,clinic.clinic_name,schedule.sched_date,schedule.sched_time,schedule.sched_num from schedule inner join clinic on schedule.clinic_id=clinic.clinic_id where clinic.clinic_id=$userid ";
                    if($_POST){
                        //print_r($_POST);
                        $sqlpt1="";
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label"> Clinic: </label>
                                </td>
                            </tr>

                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="" class="input-text" value="' . (isset($_SESSION['user']) ? $_SESSION['user'] : '') . '" readonly><br>
                                    <input type="hidden" name="docid" class="input-text" value="' . htmlspecialchars($userid) . '" hidden>
