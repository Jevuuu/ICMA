                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                ...
                                $sqlmain= "select * from appointment inner join patient on patient.patient_id=appointment.patient_id inner join schedule on schedule.sched_id=appointment.sched_id where schedule.clinic_id=$userid;";
                                $selecttype="My";
                                $current="My patients Only";
                            }
                        }
