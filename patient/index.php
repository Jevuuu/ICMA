            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $clinicrow = $database->query("select  * from  clinic;");
                                $appointmentrow = $database->query("select  * from  appointment where app_date>='$today';");
                                $schedulerow = $database->query("select  * from  schedule where sched_date='$today';");
                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about clinics? no problem let's jumping to 
                                <a href="clinics.php" class="non-style-link"><b>"All Clinics"</b></a> section or 
                                <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                Track your past and future appointments history.<br>Also find out the expected arrival time of your clinic or medical consultant.<br><br>
                            </p>
                            
                            <h3>Channel a Clinic Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search a Clinic and We will Find The Session Available" list="clinics" style="width:45%;">&nbsp;&nbsp;
                                        ...
                                        <table class="filter-container" style="border: none;" border="0">
                                            <tr>
                                                <td colspan="4">
                                                    ...
                                                    <a href="category.php" class="non-style-link-menu"><div><p style="font-size: 20px;font-weight:600;padding-left: 12px" class="menu-text">Pick Clinic Category</p></div></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 25%;">
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Channel a Clinic &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
