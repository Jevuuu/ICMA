 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
        ...
        <?php
                ...
                $sqlmain= "select * from schedule inner join clinic on schedule.clinic_id=clinic.clinic_id where schedule.sched_date>='$today'  order by schedule.sched_date asc";
                $sqlpt1="";
                $insertkey="";
                $q='';
                $searchtype="All";
                        ...
                        if(!empty($_POST["search"])){
                            ...
                            $sqlmain= "select * from schedule inner join clinic on schedule.clinic_id=clinic.clinic_id where schedule.sched_date='$today' and clinic.clinic_name='$keyword' or clinic.clinic_name like '$keyword%' or clinic.clinic_name like '%$keyword' or clinic.clinic_name like '%$keyword%' or schedule.sched_name='$keyword' or schedule.sched_name like '$keyword%' or schedule.sched_name like '%$keyword' or schedule.sched_name like '%$keyword%' or schedule.sched_date like '$keyword%' or schedule.sched_date like '%$keyword' or schedule.sched_date like '%$keyword%' or schedule.sched_date='$keyword'   order by schedule.sched_date asc";
                            //echo $sqlmain;
                            $insertkey=$keyword;
                ...
                <tr >
                    ...
                    <td >
                            <form action="" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Clinic name or Email or Date (YYYY-MM-DD)" list="clinic" value="<?php  echo $insertkey ?>">&nbsp;&nbsp;
