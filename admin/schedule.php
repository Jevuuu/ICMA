...
<body>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <select name="clinic_id" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Choose Clinic Name from the list</option><br/>
                                
                            <?php 
                            
                                $list11 = $database->query("select  * from  clinic order by clinic_name asc;");
                ...
                <?php
                    if($_POST){
                        ...
                        if(!empty($_POST["sched_date"])){
                            ...
                            $sqlpt1=" schedule.sced_date='$sheduledate' ";
                        }


                        $sqlpt2="";
                        if(!empty($_POST["clinic_id"])){
                            $docid=$_POST["clinic_id"];
                            $sqlpt2=" clinic.clinic_id=$docid ";
                        }
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select schedule.sched_id,schedule.sched_name,clinic.clinic_name,schedule.sched_date,schedule.sched_time,schedule.sched_num from schedule inner join clinic on schedule.clinic_id=clinic.clinic_id ";
                        ...
                        $sqlmain= "select schedule.sched_id,schedule.sched_name,clinic.clinic_name,schedule.sched_date,schedule.sched_time,schedule.sched_num from schedule inner join clinic on schedule.clinic_id=clinic.clinic_id  order by schedule.sched_date desc";
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            $sqlmain= "select schedule.sched_id,schedule.sched_name,clinic.clinic_name,schedule.sched_date,schedule.sched_time,schedule.sched_num from schedule inner join clinic on schedule.clinic_id=clinic.clinic_id  where  schedule.sched_id=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $docname=$row["clinic_name"];
            $scheduleid=$row["sched_id"];
            ...
            $sqlmain12= "select * from appointment inner join patient on patient.patient_id=appointment.patient_id inner join schedule on schedule.sched_id=appointment.sched_id where schedule.sched_id=$id;";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Clinic of this session: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
