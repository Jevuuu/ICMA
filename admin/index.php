            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="clinics.php" method="post" class="header-search">
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                            $sqlmain= "select schedule.sched_id,schedule.sched_name,clinic.clinic_name,schedule.sched_date,schedule.sched_time,schedule.sched_num from schedule inner join clinic on schedule.clinic_id=clinic.clinic_id  where schedule.sched_date>='$today' and schedule.sched_date<='$nextweek' order by schedule.sched_date desc"; 
                                                $result= $database->query($sqlmain);
                                                ...
                                                for ( $x=0; $x<$result->num_rows;$x++){
                                                    ...
                                                    echo '<tr>
                                                        ...
                                                        .'</td>
                                                        <td>
                                                        '.substr($docname,0,210).'
                                                        </td>
                                                        <td style="text-align:center;">
                                                            '.substr($scheduledate,0,110).' '.substr($scheduletime,0,5).'
                                                        </td>
