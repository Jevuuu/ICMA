...
<body>
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-dashbord  " >
                        <a href="index.php" class="non-style-link-menu n"><div><p class="menu-text">Dashboard</p></a></div></a>
                    </td>
                </tr>
                <tr class="menu-row">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <select name="app_id" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Choose Patient Name from the list</option><br/>
                                
                            <?php 
                                $list11 = $database->query("SELECT * from appointment ORDER BY patient_id ASC;");

                                for ($y = 0; $y < $list11->num_rows; $y++) {
                                    $row00 = $list11->fetch_assoc();
                                    
                                    $patient = $row00["patient_id"];
                ...
                <?php
                    if($_POST){
                        ...
                        if(!empty($_POST["sched_date"])){
                            ...
                            $sqlpt1=" schedule.sched_date='$sheduledate' ";
                        }
                        ...
                        $sqlmain= "select appointment.app_id,schedule.sched_id,schedule.sched_name,clinic.clinic_name,patient.patient_name,schedule.sched_date,schedule.sched_time,appointment.app_num,appointment.app_date from schedule inner join appointment on schedule.sched_id=appointment.sched_id inner join patient on patient.patient_id=appointment.patient_id inner join clinic on schedule.clinic_id=clinic.clinic_id  order by schedule.sched_date desc";
    ...
    if($_GET){
        ...
        if($action=='add-session'){
            ...
            $nameget=$_GET["sched_name"];
            $session=$_GET["session"];
            $apponum=$_GET["app_num"];
            echo '
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
